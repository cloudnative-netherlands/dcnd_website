...
const Speakers = () => {
  ...
  // Show a random selection of 10 speakers
  const displaySpeakers = speakerData.slice(0, 10);

  // Hide the section entirely until speakers are published in Sessionize
