...
const DESCRIPTION =
  "Get ready for an action-packed day. With three tracks and a diverse range of sessions to choose from, you'll have plenty of opportunities to learn from experts in the field.";
