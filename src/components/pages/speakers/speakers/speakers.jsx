...
import { SESSIONIZE_SPEAKERS_URL as scriptUrl } from 'constants/sessionize';
      ...
      {speakerData.length === 0 ? (
        <div className="flex h-32 items-center justify-center">
          <p className="text-gray-600 text-lg">
            {isLoading ? 'Loading...' : 'Speakers will be announced soon — check back later.'}
          </p>
        </div>
      ) : (
        <>
          <div className="grid grid-cols-5 sm:grid-cols-2 md:grid-cols-5 gap-4 sm:gap-6">
